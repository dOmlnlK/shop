		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="filter mt10">
				...
				<div class="filter_wrap">
					...
					<dl>
						...
						<dd><a href="/index.php/Home/Search/key_search/key/%E5%BE%AE%E6%B3%A2%E7%82%89/brand_id/<?php echo $v['brand_id']; ?>-<?php echo $v['brand_name']; ?>"><?php echo $v['brand_name']; ?></a></dd>
						<?php endforeach; ?>
					</dl>
					<?php endif; ?>
					...
					<dl>
						...
						<dd><a href="/index.php/Home/Search/key_search/key/%E5%BE%AE%E6%B3%A2%E7%82%89/price/<?php echo $v; ?>"><?php echo $v; ?></a></dd>
						<?php endforeach; ?>
					</dl>
					<?php endif; ?>
					...
					<dl>
						...
						<?php foreach ($v as $k1 => $v1): ?>
							<dd><a href="/index.php/Home/Search/key_search/key/%E5%BE%AE%E6%B3%A2%E7%82%89/<?php echo $attrUrlName; ?>/<?php echo $v1['attr_value']; ?>-<?php echo $k; ?>"><?php echo $v1['attr_value']; ?></a></dd>
						<?php endforeach; ?>
					</dl>
					<?php endforeach; ?>
				</div>
			...
			<div class="goodslist mt10">
				<ul>
					...
					<li>
						<dl>
							<dt><a href="<?php echo U('Index/goods/?id='.$v['id']); ?>"><?php showPic($v['mid_logo']); ?></a></dt>
