			...
			<div class="filter mt10">
				...
				<div class="filter_wrap">
					...
					<dl>
						...
						<dd><a href="/index.php/Home/Search/cat_search/cat_id/4/brand_id/<?php echo $v['brand_id']; ?>-<?php echo $v['brand_name']; ?>"><?php echo $v['brand_name']; ?></a></dd>
						<?php endforeach; ?>
					</dl>
					<?php endif; ?>
					...
					<dl>
						...
						<dd><a href="/index.php/Home/Search/cat_search/cat_id/4/price/<?php echo $v; ?>"><?php echo $v; ?></a></dd>
						<?php endforeach; ?>
					</dl>
					<?php endif; ?>
					...
					<dl>
						...
						<?php foreach ($v as $k1 => $v1): ?>
							<dd><a href="/index.php/Home/Search/cat_search/cat_id/4/<?php echo $attrUrlName; ?>/<?php echo $v1['attr_value']; ?>-<?php echo $k; ?>"><?php echo $v1['attr_value']; ?></a></dd>
						<?php endforeach; ?>
					</dl>
					<?php endforeach; ?>
				</div>
