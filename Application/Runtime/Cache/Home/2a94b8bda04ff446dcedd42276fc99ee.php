...
<head>
    ...
    <meta name="description" content="jx购物商城，为您提供正品低价的购物选择、优质便捷的服务体验。商品来自全球数十万品牌商家，囊括家电、手机、电脑、服装、居家、母婴、美妆、个护、食品、生鲜等丰富品类，满足各种购物需求。">
    <meta name="Keywords" content="网上购物,网上商城,家电,手机,电脑,服装,居家,母婴,美妆,个护,食品,生鲜,jx，shop.dominik.vip,dominik的购物网站">
...
<script>
	...
	<div class="guide w1210 bc mt15">
		...
		<div class="guide_content fl">
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
                        <?php foreach($pro_goods as $v):?>
						<li>
							<dl>
								<dt><a href="<?php echo U('goods?id='.$v['id'])?>"><?php showPic($v['mid_logo'])?></a></dt>
	...
	<div style="clear:both;"></div>
	<?php foreach($floor_data['cat_list'] as $k=>$v):?>
	<!--1F 电脑办公 start -->
	<div class="floor1 floor w1210 bc mt10">
		...
		<div class="floor_left fl">
			...
			<div class="cate fl">
				...
				<div class="cate_wrap">
					<ul>
						<?php foreach($v['sub_cat'] as $k1=>$v1):?>
			...
			<div class="goodslist fl">
				<h2>
					<?php foreach($v['rec_sub_cat'] as $k2=>$v2):?>
					<span <?php echo $k2==0?'class="on"':'';?>><?php echo ($v2["cat_name"]); ?></span>
					<?php endforeach?>
				</h2>

				<div class="goodslist_wrap">
					<?php foreach($v['rec_sub_cat'] as $k1=>$v1):?>
					<div style="<?php echo $k1>0?'display:none':'';?>">
					<ul>
						<?php foreach($v1['goods'] as $k2=>$v2):?>
						<li>
							<dl>
								<dt><a href="<?php echo U('goods?id='.$v2['id'])?>"><?php showPic($v2['mid_logo'])?></a></dt>
		...
		<div class="sidebar fl ml10">
			...
			<div class="brand">
				...
				<div class="sidebar_wrap">
					<ul>
						<?php foreach($floor_data['brand_list'] as $b):?>
						<li><a href=""><?php showPic($b['logo'])?></a></li>
						<?php endforeach?>
					</ul>
				</div>
			</div>
