...
<div class="main-div">
    <form name="main_form" method="POST" action="/index.php/Admin/Attribute/add/type_id/4.html" enctype="multipart/form-data">
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <textarea rows="6" cols="30" name="attr_option_values"></textarea>
            ...
            <tr>
                ...
                <td>
                    <?php buildSelect('type','type_id','type_name','id',I('get.type_id'))?>
                </td>
            </tr>
            <tr>
