...
(
	...
	cat_id int unsigned not null  comment '主分类id',
	...
	sort_num tinyint unsigned not null default '100' comment '权重',
	primary key (id),
...
INSERT INTO ec_admin(id,username,password) VALUES(1,'root','21232f297a57a5a743894a0e4a801fc3');
